...
%   THIS PROGRAM REQUIRES MATLAB OR YOU CAN INSTALL THE APPLICATION FILE WHICH WILL %   INSTALL THE PROGRAM AND THE MATLAB RUNTIME.
...
%   .wav files, and output is the same number of .mat files with a 1 x n vector of %   %   pressure data.
